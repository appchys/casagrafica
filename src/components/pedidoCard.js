    ...
    <div class="pedido-card" data-doc-id="${pedido._docId}">
      <div class="pedido-card-top">
        <div style="display:flex; align-items:center; gap:6px;">
          ...
          <button type="button" class="btn-print-card" data-card-print="${pedido._docId}" title="Imprimir Recibo">
      ...
      <div style="display:flex; justify-content:space-between; align-items:center; gap:10px;">
        <div>
          <div class="pedido-card-name">${pedido.cliente_nombre}</div>
          ${pedido.cliente_telefono ? `<div class="pedido-card-tel" style="display:inline-flex; align-items:center; gap:4px;"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg> ${pedido.cliente_telefono}</div>` : ''}
        </div>
